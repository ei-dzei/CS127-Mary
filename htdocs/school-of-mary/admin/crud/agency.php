...
/* Lookups */
$types = $pdo->query("SELECT TYPE_CODE, TYPE_LABEL FROM TYPE_AGENCY ORDER BY TYPE_LABEL")
...
<section class="panel">
  ...
  <table>
    <thead>
      <tr><th>ID</th><th>Name</th><th>Type</th><th>Contact</th><th>Actions</th></tr>
    </thead>
    <tbody>
        ...
        <td style="white-space:nowrap">
          ...
          <template id="tpl-edit-<?php echo (int)$row['AGENCY_ID']; ?>">
            <div class="grid">
              <div class="field" style="grid-column: span 6">
                <label>Name</label>
                <input class="input" name="AGENCY_NAME" value="<?php echo htmlspecialchars($row['AGENCY_NAME']); ?>" required>
              </div>
              <div class="field" style="grid-column: span 3">
                <label>Type</label>
                <select class="input" name="AGENCY_TYPE" required>
              ...
              <div class="field" style="grid-column: span 3">
                <label>Contact</label>
                <input class="input" name="AGENCY_CONTACTINFO" value="<?php echo htmlspecialchars($row['AGENCY_CONTACTINFO']); ?>" required>
              </div>
            </div>
          </template>
        </td>
