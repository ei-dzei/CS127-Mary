...
<section class="panel fade-in crud-header-card">
  <div style="display:flex; gap:10px; flex-wrap:wrap; margin-bottom:12px; float:inline-end">
    ...
    <button class="btn-action btn-primary" id="create-faculty" style="font-size:0.8rem; font-family: 'Newsreader', serif;">
  ...
  <p class="muted" style="margin-bottom:10px;">Manage faculty directory by their profiles, contact details, academic ranks, and departmental affiliations.</p>
  ...
  <form method="get" class="filterbar" style="margin-bottom:10px;">
      <div class = "searchbox" style="font-family: 'Newsreader', serif;">
        ...
        <input class="input" type="search" name="q" value="<?= htmlspecialchars($q); ?>" placeholder="Search faculty name or email" style="width:70%; font-family: 'Newsreader', serif;"/>
