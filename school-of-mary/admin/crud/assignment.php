...
<section class="panel fade-in crud-header-card">
  <div style="display:flex; gap:10px; flex-wrap:wrap; margin-bottom:12px; float:inline-end">
    ...
    <button class="btn-action btn-primary" id="create-assignment" style="font-size:0.8rem; font-family: 'Newsreader', serif;">
  ...
  <p class="muted" style="margin: 4px 0 0 0;">Manage assignments of faculty to research projects, define their roles, and set target dates.</p>
  ...
  <form method="get" class="filterbar" style="margin-bottom:10px;">
    <div class="searchbox" style="font-family: 'Newsreader', serif;">
      ...
      <input class="input" type="search" name="q" value="<?= htmlspecialchars($q); ?>" placeholder="Search faculty name or research project" style="width:70%; font-family: 'Newsreader', serif;"/>
